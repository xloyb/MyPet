...
import { UpdateSettings, UpdateUser } from '@/app/lib/actions';
            ...
            <div className="w-full min-h-screen py-1 md:w-2/3 lg:w-3/4">
                <div className="p-2 md:p-4">
                    <div className="w-full px-6 pb-8 mt-8 sm:max-w-xl sm:rounded-lg">
                        <h2 className="pl-6 text-2xl font-bold sm:text-xl">User Controle Panel</h2>

                        <form action={UpdateSettings} className="grid max-w-2xl mx-auto mt-8">
