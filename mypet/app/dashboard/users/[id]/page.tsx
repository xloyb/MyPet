        ...
        <div className="p-2 md:p-4">
          <div className="w-full px-6 pb-8 mt-8 sm:max-w-xl sm:rounded-lg">
            <h2 className="pl-6 text-2xl font-bold sm:text-xl">
              Update User {fetchedUser.username} 's Account
            </h2>
            ...
            <form action={UpdateUser} className="grid max-w-2xl mx-auto mt-8">
              ...
              <div className="items-center mt-8 sm:mt-14 ">
                ...
                <select
                  name="isTeam"
                  id="isTeam"
                  className="block w-full mt-2 px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                >
                  <option value="">Is Team?</option>
                  <option value="true">Yes</option>
                  <option value="false">No</option>
                </select>
